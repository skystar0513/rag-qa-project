...
또한 질문 결과를 저장하고 분석하는 기능을 추가하여,**문서 활용 데이터를 축적하고 자동화하는 시스템으로 확장**했습니다.
---
...
│  ├─ logger.py # CSV 로그 저장
│  ├─ log_reader.py # 로그 분석
│  └─ faq.py #FAQ 생성 및 유사 질문 그룹화
├─ logs/
│ └── qa_log.csv # 질문/답변 로그
│ └── test_log.csv #질문 그룹화 테스트 로그
├─ data/
│  └─ sample.pdf          # 테스트용 문서
├─ .env                   # OpenAI API Key
├─ requirements.txt
...
![upload](assets/demo4.png)
![upload](assets/demo5.png)